    ...
    >
      <div className="shell relative">
        ...
        <div className="pt-24 md:pt-32 pb-32 flex flex-col md:flex-row items-center gap-12 relative">
          ...
          <div className="w-full md:w-5/12 relative group">
            <div className="aspect-[3/4] overflow-hidden border border-[#C5A059]/30 relative p-4 z-10">
              <div className="w-full h-full relative overflow-hidden" style={{ border: `2px solid ${BRASS_GOLD}` }}>
                <img 
            ...
            {/* Interface Note */}
            <div className={`${noteClass} -right-16 md:-right-32 top-1/4 bg-[#2A3B2C] border-[#B35A3B] text-[#B35A3B]`}>
          ...
          <div className="w-full md:w-7/12 z-10">
            ...
            <div className="mt-12 max-w-md font-mono text-sm tracking-widest uppercase opacity-80 leading-relaxed border-l-2 pl-6" style={{ borderColor: TERRACOTTA }}>
        ...
        <div className="py-32 relative">
          ...
          <div className={`${noteClass} -left-8 md:-left-24 bottom-1/4 bg-[#2A3B2C] border-[#C5A059] text-[#C5A059]`}>
        ...
        <div className="py-48 relative overflow-hidden">
          <div className={`${noteClass} left-0 top-12 bg-[#2A3B2C] border-[#B35A3B] text-[#B35A3B]`}>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-16 md:gap-24">
            ...
            <motion.div style={{ y: y1 }} className="flex flex-col items-center">
              <div className="w-48 h-48 md:w-64 md:h-64 rounded-full overflow-hidden border-[6px] border-[#2A3B2C] outline outline-2 outline-[#C5A059] relative z-10 shadow-2xl">
                <img src="/images/art_deco_circle_progress.jpg" alt="Progress" className="w-full h-full object-cover" />
              </div>
              <div className="mt-8 font-serif text-xl tracking-widest uppercase">Progress</div>
            ...
            <motion.div style={{ y: y2 }} className="flex flex-col items-center mt-24 md:mt-0">
              <div className="w-56 h-56 md:w-72 md:h-72 rounded-full overflow-hidden border-[8px] border-[#2A3B2C] outline outline-[3px] outline-[#B35A3B] relative z-10 shadow-2xl">
                <img src="/images/art_deco_circle_power.jpg" alt="Power" className="w-full h-full object-cover" />
              </div>
              <div className="mt-8 font-serif text-xl tracking-widest uppercase" style={{ color: TERRACOTTA }}>Power</div>
            ...
            <motion.div style={{ y: y3 }} className="flex flex-col items-center">
              ...
              <div className="mt-8 font-serif text-xl tracking-widest uppercase">Motion</div>
              <div className="h-8 w-px mt-4" style={{ backgroundColor: TERRACOTTA }}></div>
            </motion.div>
        ...
        <div className="pt-24 pb-12 border-t border-[#C5A059]/20 flex flex-col md:flex-row items-end justify-between gap-8 relative overflow-hidden">
          ...
          <div className="font-sans font-black text-6xl md:text-8xl tracking-tighter uppercase opacity-10 flex-shrink-0" style={{ color: BRASS_GOLD }}>
            TICKETS
          </div>

          <div className={`${noteClass} right-0 top-12 bg-[#2A3B2C] border-[#C5A059] text-[#C5A059]`}>
