    ...
    >
      ...
      <div className="mb-24 md:mb-32 flex flex-col md:flex-row md:items-end justify-between gap-8">
        ...
        <p className="text-base text-text-grey font-mono max-w-md">
          {language === 'en' 
            ? 'A journey through different phases, styles, and approaches to system building and life.'
            : 'رحلة عبر مراحل وأساليب مختلفة في بناء الأنظمة والحياة.'}
        </p>
      </div>
